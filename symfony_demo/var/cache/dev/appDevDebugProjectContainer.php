...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.type.tagsinput' => 'getApp_Form_Type_TagsinputService',
            'app.redirect_to_preferred_locale_listener' => 'getApp_RedirectToPreferredLocaleListenerService',
            'app.requirements_subscriber' => 'getApp_RequirementsSubscriberService',
        ...
        $this->privates = array(
            ...
            'code_explorer.twig.source_code_extension' => true,
    ...
    /**
     * Gets the 'app.form.type.tagsinput' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\TagsInputType A AppBundle\Form\Type\TagsInputType instance
     */
    protected function getApp_Form_Type_TagsinputService()
    {
        return $this->services['app.form.type.tagsinput'] = new \AppBundle\Form\Type\TagsInputType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['app.redirect_to_preferred_locale_listener'] = new \AppBundle\EventListener\RedirectToPreferredLocaleListener($this->get('router'), 'en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr', 'en');
    }

    /**
     * Gets the 'app.requirements_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\CheckRequirementsSubscriber A AppBundle\EventListener\CheckRequirementsSubscriber instance
     */
    protected function getApp_RequirementsSubscriberService()
    {
        return $this->services['app.requirements_subscriber'] = new \AppBundle\EventListener\CheckRequirementsSubscriber($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4CUWonF7OD', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kS4rWIvnpy', 0, '6aug6wahVHDrM7Z9kRtqE8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app.requirements_subscriber', 'AppBundle\\EventListener\\CheckRequirementsSubscriber');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ebccf4c368eba33c2a4cc5330c76aa9aef7dcd67e54cfc86ce337d43e2f54c12');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('AppBundle\\Form\\Type\\TagsInputType' => 'app.form.type.tagsinput', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => 'form.type.form', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => 'form.type.choice', 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType' => 'form.type.entity'), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.csrf', 4 => 'form.type_extension.form.data_collector'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => array(0 => 'form.type_extension.repeated.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('g3diK6VBMK', NULL, '6aug6wahVHDrM7Z9kRtqE8', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr)/admin');
        ...
        $l->setOptions(array('login_path' => 'security_login', 'default_target_path' => 'blog_index', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\AppExtension($this->get('markdown'), 'en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RC2E4GHQN1', 0, '6aug6wahVHDrM7Z9kRtqE8', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
